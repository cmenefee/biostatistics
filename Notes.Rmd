...
For simplicity, assign all the columns of the dataset to their own separate variables using the attach function. We do not recommend this approach in general, especially when multiple datasets
